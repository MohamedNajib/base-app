...
extension WidgetExtension on Widget {
  ...
  /// +--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+
  /// | set parent widgets in center use [Center] widgets                                         |
  /// +--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+
  Widget get center => Center(child: this);

  /// +--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+
  /// | add Expanded to parent widgets use [Expanded] widgets                                     |
  /// +--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+
  Widget get expand => Expanded(child: this);

  Widget expandFlex({int flex = 1}) => Expanded(child: this, flex: flex);

  /// +--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+
  /// | add Scroll to parent widgets use [SingleChildScrollView] widgets                          |
  /// +--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+
  Widget get withVerticalScroll => SingleChildScrollView(child: this, scrollDirection: Axis.vertical);

  Widget get withHorizontalScroll => SingleChildScrollView(child: this, scrollDirection: Axis.horizontal);

  /// +--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+
  /// | add MouseRegion to parent widgets [MouseRegion] to Change the Cursors to Pointer         |
  /// +--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+
  Widget get withCursorsPointer => MouseRegion(
        cursor: SystemMouseCursors.click,
        child: this,
      );

  /// +--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+
  /// | add FittedBox to parent widgets [FittedBox] widgets                                       |
  /// +--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+--+
  Widget get fit => FittedBox(child: this);

  ///
  /// add onTap for any widgets
  ///
  Widget onTap(
    Function? function, {
